...
//        });
    ...
    /* Single Instance! you can create a new instance only if you do not have instance () */
    ...
    public FXMLLoader loadFXML(String nomeCena) {
        ...
        try {
            //System.out.println(getClass().getResource("/bridgechat/viewers/" + nomeCena + ".fxml"));
            loader.setLocation(getClass().getResource("/bridgechat/viewers/" + nomeCena + ".fxml"));
            loader.load();  
        } catch (IOException e) {
